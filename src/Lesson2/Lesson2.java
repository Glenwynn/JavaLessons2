...
public class Lesson2 {
    ...
    public static class HomeWork2 {
        ...
        private static void emiCalc(double[][] human) {
            ...
            for (double[] doubles : human) {
                for (int j = 0; j < doubles.length; j += 2) {
                    double bmi = doubles[j] / (doubles[j + 1] * doubles[j + 1]);

                    System.out.printf("Weight: %.2f\tHeight: %.2f | BMI: %.2f | ", doubles[j], doubles[j + 1], bmi);
